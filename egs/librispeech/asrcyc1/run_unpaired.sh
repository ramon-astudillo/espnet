...
# tacotron loss
asr_model_conf=exp/train_100_blstmp_e8_subsample1_2_2_1_1_unit320_proj320_d1_unit300_location_aconvc10_aconvf100_mtlalpha0.0_adadelta_bs50_mli800_mlo150/results/model.conf
asr_model=exp/train_100_blstmp_e8_subsample1_2_2_1_1_unit320_proj320_d1_unit300_location_aconvc10_aconvf100_mtlalpha0.0_adadelta_bs50_mli800_mlo150/results/model.acc.best
...
#train_set=train_100
train_set=train_460
train_paired=train_clean_100
train_unpaired=train_clean_360
train_dev=dev
...
lmexpdir=exp/train_rnnlm_2layer_bs256_icassp2019
mkdir -p ${lmexpdir}
if [ ${stage} -le 3 ]; then
    echo "stage 3: LM Preparation"
    lmdatadir=data/local/lm_train_icassp2019
    mkdir -p ${lmdatadir}
...
if [ ${stage} -le 4 ]; then
    ...
    ${cuda_cmd} --gpu ${ngpu} ${expdir}/train.log \
        ...
        --verbose ${verbose} \
        --resume ${resume} \
        --train-json ${feat_tr_paired_dir}/train_clean_100.json \
                     ${feat_tr_unpaired_dir}/train_clean_360_audio.json \
